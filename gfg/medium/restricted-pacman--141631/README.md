...
0 + 2 + 7 = 9
and so on.
1,3 and 5 are the only indices that cannot be visited.Therefore the candies at these two postions will be left on the board 
```
...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-26T16:33:02.111Z  
...
[View on GeeksforGeeks](https://practice.geeksforgeeks.org/problems/restricted-pacman--141631/1)